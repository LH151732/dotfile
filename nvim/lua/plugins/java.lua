    ...
    config = function()
      ...
      local function setup_jdtls()
        ...
        if mason_registry.is_installed("jdtls") then
          ...
          vim.notify("找到JDTLS路径: " .. jdtls_path, vim.log.levels.INFO)
        else
        ...
        if not root_dir then
          ...
          vim.notify("未找到Java项目标记，使用当前目录: " .. root_dir, vim.log.levels.INFO)
        else
          vim.notify("找到Java项目根目录: " .. root_dir, vim.log.levels.INFO)
        end
            ...
            java = {
              ...
              configuration = {
                ...
                runtimes = {
                  ...
                  {
                    name = "JavaSE-23",
                    path = vim.fn.expand("~/.sdkman/candidates/java/23.0."),
                  },
                },
              },
              maven = {
      ...
      vim.api.nvim_create_autocmd("FileType", {
        pattern = "java",
        callback = function()
          vim.notify("检测到Java文件，正在启动JDTLS...", vim.log.levels.INFO)
          setup_jdtls()
        end,
      })
      ...
      if vim.bo.filetype == "java" then
        vim.notify("当前文件是Java，立即启动JDTLS...", vim.log.levels.INFO)
        setup_jdtls()
      end
    end,
  },
